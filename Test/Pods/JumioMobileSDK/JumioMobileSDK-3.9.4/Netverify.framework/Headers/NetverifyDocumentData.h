...
#ifndef NETVERIFY_DOCUMENT_DATA
#define NETVERIFY_DOCUMENT_DATA
/**
 ...
 **/
@property (nonatomic, strong, nullable) NSString *selectedCountry;
 ...
 **/
@property (nonatomic, strong, nullable) NSString *rawBarcodeFirstName;
...
/**
 *  Returns the raw image data within an UIImage for front in case this feature is enabled serverside.
 *  Please contact your Jumio Account Manger or support@jumio.com in case you want to receive the images here.
 **/
@property (nonatomic, strong, nullable) UIImage *frontImage;

/**
 *  Returns the raw image data within an UIImage for back in case this feature is enabled serverside.
 *  Please contact your Jumio Account Manger or support@jumio.com in case you want to receive the images here.
 **/
@property (nonatomic, strong, nullable) UIImage *backImage;

/**
 *  Returns the raw image data within an UIImage for face in case this feature is enabled serverside.
 *  Please contact your Jumio Account Manger or support@jumio.com in case you want to receive the images here.
 **/
